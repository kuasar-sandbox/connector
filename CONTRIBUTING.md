...
Open a pull request from `<your-login>/connector:feat/short-description` to `kuasar-sandbox/connector:main`. Enable **Allow edits from maintainers** when appropriate.
