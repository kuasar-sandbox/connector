...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang -cflags "-O2 -g -Wall -Werror" -go-package vswitch -output-dir ../../vswitch -output-suffix _test -tags integration -target amd64 statsProbe ../../../bpf/stats_test.c -- -I../../../bpf
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang -cflags "-O2 -g -Wall -Werror" -go-package vswitch -output-dir ../../vswitch -output-suffix _test -tags integration -target arm64 statsProbe ../../../bpf/stats_test.c -- -I../../../bpf
